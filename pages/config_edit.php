...
$f_reminder_bug_status			= gpc_get_int_array('reminder_bug_status', array(ASSIGNED));
...
$f_reminder_feedback_status		= gpc_get_int_array('reminder_feedback_status',array(FEEDBACK));
